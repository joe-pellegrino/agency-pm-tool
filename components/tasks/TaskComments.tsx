...
export default function TaskComments({ taskId }: TaskCommentsProps) {
  ...
  const currentColor = currentUser?.color || '#4F6AE8';
    ...
    <div>
      ...
      {loading ? (
        <div className="flex items-center justify-center py-8">
          <Loader2 size={18} className="animate-spin" style={{ color: '#4F6AE8' }} />
        </div>
      ) : comments.length === 0 ? (
        <p className="text-sm text-center py-6" style={{ color: '#8B95A5' }}>
          ...
          {grouped.map(group => (
            <div key={group.label}>
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="flex-1 h-px" style={{ backgroundColor: '#E8ECF1' }} />
                <span className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: '#8B95A5', letterSpacing: '1px' }}>
                  {group.label}
                </span>
                <div className="flex-1 h-px" style={{ backgroundColor: '#E8ECF1' }} />
              </div>
              ...
              <div className="space-y-3">
                {group.comments.map(comment => {
                  ...
                  const color = author?.color || '#4F6AE8';
      ...
      <form onSubmit={handleSubmit} className="flex items-start gap-3">
        ...
        <div className="flex-1 flex items-center gap-2">
          ...
          <button
            ...
            style={{ backgroundColor: text.trim() && !submitting ? '#4F6AE8' : '#D0D5DD' }}
          >
