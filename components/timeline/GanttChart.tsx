    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-4 sm:px-5 py-3.5 border-b border-gray-200 dark:border-gray-700 flex-wrap gap-y-2">
        ...
        <button
          ...
          className="text-xs font-medium text-[#3B5BDB] hover:text-[#3B5BDB] px-2.5 py-1.5 rounded-lg hover:bg-[#EEF2FF] dark:hover:bg-indigo-900/20 transition-colors"
        >
          Today
        </button>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#3B5BDB]"
          >
        ...
        <div className="hidden sm:flex items-center gap-3 ml-2">
          {CLIENTS.map(c => (
            <div key={c.id} className="flex items-center gap-1.5">
              <div className="w-3 h-3 rounded-sm" style={{ backgroundColor: '#000000' }} />
