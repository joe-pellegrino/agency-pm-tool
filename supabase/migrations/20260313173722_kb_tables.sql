-- Add type and yjs_state to documents
...
-- Add resolved/document_id to comments
ALTER TABLE comments ADD COLUMN IF NOT EXISTS resolved BOOLEAN DEFAULT false;
ALTER TABLE comments ADD COLUMN IF NOT EXISTS document_id_fk TEXT REFERENCES documents(id) ON DELETE CASCADE;
